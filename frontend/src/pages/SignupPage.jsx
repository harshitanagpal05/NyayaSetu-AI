...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!agreed) { setError('Please agree to the terms and disclaimer.'); return }
    setError('')
    setLoading(true)
    try {
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            <h2 className="font-display text-3xl font-bold text-white mb-6 leading-tight">
              Start your journey<br />to <span className="gold-gradient italic">legal clarity</span>
            </h2>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-navy-950">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 font-body text-sm">Free forever. No credit card required.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3 pt-1">
              ...
              <label className="text-xs text-slate-400 font-body leading-relaxed cursor-pointer" onClick={() => setAgreed(v => !v)}>
                I understand that Legal AI provides educational information only, not legal advice. 
                I agree to the{' '}
                <a href="#" className="text-gold-400 hover:text-gold-300">Terms of Service</a> and{' '}
