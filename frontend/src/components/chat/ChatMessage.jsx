  ...
  return (
    <div className="flex items-start gap-3 justify-end animate-fade-up">
      <div className="max-w-[80%] flex flex-col items-end gap-1">
        ...
        <span className="text-[10px] text-slate-600 font-body px-1">
          {formatTime(message.timestamp)}
        </span>
      </div>

      <div className="w-8 h-8 rounded-xl bg-gold-500/20 border border-gold-500/30 flex items-center justify-center flex-shrink-0 text-gold-300 text-xs font-bold font-body mt-0.5">
...
function AIMessage({ message }) {
  ...
  return (
    <div className="flex items-start gap-3 animate-fade-up group">
      <div
      ...
      <div className="max-w-[85%] flex flex-col gap-2">
        <div
          className={`chat-bubble-ai relative ${
