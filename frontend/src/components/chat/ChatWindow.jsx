...
return ( <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 text-center"> <div className="relative mb-8"> <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center shadow-2xl shadow-gold-500/30 mx-auto"> <Scale size={32} className="text-navy-900" strokeWidth={2} /> </div> <div className="absolute inset-0 rounded-3xl bg-gold-500/20 blur-2xl animate-pulse-slow" /> </div>
